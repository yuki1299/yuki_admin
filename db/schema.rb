...
ActiveRecord::Schema.define(version: 20171124061321) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "answers", force: :cascade do |t|
    t.text     "testers_answer"
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.integer  "project_answer_id"
    t.string   "project_answer_type"
    t.integer  "tester_id"
    t.index ["tester_id"], name: "index_answers_on_tester_id", using: :btree
  end
  ...
  create_table "projects", force: :cascade do |t|
    ...
    t.string   "status"
    t.string   "url_html"
    t.integer  "number_answers", default: 0
  end
  ...
  add_foreign_key "answers", "testers"
